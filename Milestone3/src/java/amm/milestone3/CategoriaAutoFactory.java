...
public class CategoriaAutoFactory {
    ...
    private CategoriaAutoFactory() {
        ...
        listaCategoriaAuto.add(new CategoriaAuto(2,"Berline","Per berlina si intende la carrozzeria d'autovettura con tetto fisso, generalmente dotata di 4 o 5 porte e principalmente realizzata nelle configurazioni a due, tre o due volumi e mezzo. Il termine berlina indicava, in origine, un particolare tipo di carrozza."));
    }
